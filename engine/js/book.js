...
PBS.KIDS.storybook.book = function (GLOBAL, PBS, storybookContainerElement, config) {
    ...
    var sb = PBS.KIDS.storybook,
        ...
        //convenience for setting prefixed css properties.
        setCSSProperty = function (element, property, value, prefixed) {
            var vendors = ['ms', 'moz', 'webkit', 'o'], i;
            if (prefixed) {
                for (i = 0; i < vendors.length; i += 1) {
                    element.style["-" + vendors[i] + "-" + property] = value;
                }
            }
        ...
        addClass = function( elem, value, remove ) {
        ...
        updatePosition = function () {
            ...
            if (curPageIndex === -1) {
                setCSSProperty(bookContainerElement,"transition","","prefixed");
                ...
                if (curOrientation === "SINGLE-PAGE") {
                    setCSSProperty(bookContainerElement,"transition","margin-left " + pageSlideDuration / 1000 + "s linear" ,"prefixed");
        ...
        init = function () {
            ...
            if (!initialized) {
                ...
                bookContainerElement.setAttribute("role","region");
                bookContainerElement.setAttribute("aria-live","polite");
                ...
                if (bookConfig.previousPageButton) {
                    ...
                    prevPageButtonSprite.getElement().setAttribute("aria-controls","pbsBookContainer");
                    prevPageButtonSprite.getElement().innerHTML="Go to the last page";
                ...
                if (bookConfig.nextPageButton) {
                    ...
                    nextPageButtonSprite.getElement().setAttribute("aria-controls","pbsBookContainer");
                    nextPageButtonSprite.getElement().innerHTML="Go to the next page";
